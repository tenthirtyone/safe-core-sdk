...
class SafeEthersSigner extends abstract_signer_1.VoidSigner {
   ...
   */
  static async create(safe, service, provider, options) {
  ...
  constructor(safe, safeAddress, service, provider, options) {
    ...
    return {
      ...
      wait: async (confirmations) => {
        ...
        while (true) {
          ...
          await sleep(
            (_b = (_a = this.options) === null || _a === void 0 ? void 0 : _a.pollingDelay) !==
              null && _b !== void 0
              ? _b
              : 5000
          )
  ...
  async sendTransaction(transaction) {
    ...
    let to = await tx.to
    let data =
      (_b = (_a = await tx.data) === null || _a === void 0 ? void 0 : _a.toString()) !== null &&
      _b !== void 0
        ? _b
        : '0x'
