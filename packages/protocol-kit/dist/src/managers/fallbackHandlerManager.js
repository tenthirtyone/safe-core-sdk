...
var _FallbackHandlerManager_ethAdapter,
  _FallbackHandlerManager_safeContract,
  _FallbackHandlerManager_slot
...
class FallbackHandlerManager {
  constructor(ethAdapter, safeContract) {
    ...
    _FallbackHandlerManager_slot.set(
      this,
  ...
  validateFallbackHandlerAddress(fallbackHandlerAddress) {
    const isValidAddress = __classPrivateFieldGet(
      this,
      _FallbackHandlerManager_ethAdapter,
      'f'
    ).isAddress(fallbackHandlerAddress)
  ...
  async getFallbackHandler() {
    ...
    if ((0, utils_1.hasSafeFeature)(utils_1.SAFE_FEATURES.SAFE_FALLBACK_HANDLER, safeVersion)) {
      return __classPrivateFieldGet(this, _FallbackHandlerManager_ethAdapter, 'f').getStorageAt(
        __classPrivateFieldGet(this, _FallbackHandlerManager_safeContract, 'f').getAddress(),
        __classPrivateFieldGet(this, _FallbackHandlerManager_slot, 'f')
      )
    } else {
      throw new Error(
  ...
  async encodeEnableFallbackHandlerData(fallbackHandlerAddress) {
    ...
    return __classPrivateFieldGet(this, _FallbackHandlerManager_safeContract, 'f').encode(
      'setFallbackHandler',
...
;(_FallbackHandlerManager_ethAdapter = new WeakMap()),
  (_FallbackHandlerManager_safeContract = new WeakMap()),
  (_FallbackHandlerManager_slot = new WeakMap())
