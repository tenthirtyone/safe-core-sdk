...
const GnosisSafeContract_V1_0_0_Ethers_1 = __importDefault(
  require('./GnosisSafe/v1.0.0/GnosisSafeContract_V1_0_0_Ethers')
)
const GnosisSafeContract_V1_1_1_Ethers_1 = __importDefault(
  require('./GnosisSafe/v1.1.1/GnosisSafeContract_V1_1_1_Ethers')
)
const GnosisSafeContract_V1_2_0_Ethers_1 = __importDefault(
  require('./GnosisSafe/v1.2.0/GnosisSafeContract_V1_2_0_Ethers')
)
const GnosisSafeContract_V1_3_0_Ethers_1 = __importDefault(
  require('./GnosisSafe/v1.3.0/GnosisSafeContract_V1_3_0_Ethers')
)
const GnosisSafeProxyFactoryContract_V1_0_0_Ethers_1 = __importDefault(
  require('./GnosisSafeProxyFactory/v1.0.0/GnosisSafeProxyFactoryContract_V1_0_0_Ethers')
)
const GnosisSafeProxyFactoryContract_V1_1_1_Ethers_1 = __importDefault(
  require('./GnosisSafeProxyFactory/v1.1.1/GnosisSafeProxyFactoryContract_V1_1_1_Ethers')
)
const GnosisSafeProxyFactoryContract_V1_3_0_Ethers_1 = __importDefault(
  require('./GnosisSafeProxyFactory/v1.3.0/GnosisSafeProxyFactoryContract_V1_3_0_Ethers')
)
...
function getSafeProxyFactoryContractInstance(safeVersion, contractAddress, signerOrProvider) {
  ...
  switch (safeVersion) {
    case '1.3.0':
      gnosisSafeProxyFactoryContract = Proxy_factory__factory_3.Proxy_factory__factory.connect(
        contractAddress,
        signerOrProvider
      )
      return new GnosisSafeProxyFactoryContract_V1_3_0_Ethers_1.default(
        gnosisSafeProxyFactoryContract
      )
    case '1.2.0':
    case '1.1.1':
      gnosisSafeProxyFactoryContract = Proxy_factory__factory_2.Proxy_factory__factory.connect(
        contractAddress,
        signerOrProvider
      )
      return new GnosisSafeProxyFactoryContract_V1_1_1_Ethers_1.default(
        gnosisSafeProxyFactoryContract
      )
    case '1.0.0':
      gnosisSafeProxyFactoryContract = Proxy_factory__factory_1.Proxy_factory__factory.connect(
        contractAddress,
        signerOrProvider
      )
      return new GnosisSafeProxyFactoryContract_V1_0_0_Ethers_1.default(
        gnosisSafeProxyFactoryContract
      )
    default:
      throw new Error('Invalid Safe version')
