...
class EthersAdapter {
  ...
  async getSignerAddress() {
    var _a
    return (_a = __classPrivateFieldGet(this, _EthersAdapter_signer, 'f')) === null || _a === void 0
      ? void 0
      : _a.getAddress()
  }
  signMessage(message) {
  ...
  async signTypedData(safeTransactionEIP712Args) {
    ...
    if ((0, utils_2.isTypedDataSigner)(__classPrivateFieldGet(this, _EthersAdapter_signer, 'f'))) {
      ...
      const signature = await __classPrivateFieldGet(
        ...
        'f'
      )._signTypedData(typedData.domain, { SafeTx: typedData.types.SafeTx }, typedData.message)
      return signature
    }
