...
async function getSafeContract({
  ...
  const gnosisSafeContract = await ethAdapter.getSafeContract({
    ...
    customContractAddress:
      customSafeAddress !== null && customSafeAddress !== void 0
        ? customSafeAddress
        : customContracts === null || customContracts === void 0
        ? void 0
        : customContracts.safeMasterCopyAddress,
    customContractAbi:
      customContracts === null || customContracts === void 0
        ? void 0
        : customContracts.safeMasterCopyAbi
  })
...
async function getMultiSendContract({ ethAdapter, safeVersion, customContracts }) {
  ...
  const multiSendContract = await ethAdapter.getMultiSendContract({
    ...
    customContractAbi:
      customContracts === null || customContracts === void 0 ? void 0 : customContracts.multiSendAbi
  })
